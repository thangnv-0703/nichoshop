        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingFee = table.Column<decimal>(type: "decimal(13,2)", nullable: false),
                    Discount = table.Column<decimal>(type: "decimal(13,2)", nullable: false),
                    OrderDate = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    OrderFullName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    OrderPhoneNumber = table.Column<string>(type: "varchar(15)", maxLength: 15, nullable: false),
                    OrderOtherDetails = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    OrderStreet = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    OrderWard = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    OrderDistrict = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    OrderProvince = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SkuNo = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    ProductId = table.Column<int>(type: "int", nullable: false),
                    ProducVarianttName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ValueId = table.Column<int>(type: "int", nullable: false),
                    RawValue = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ProductId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
