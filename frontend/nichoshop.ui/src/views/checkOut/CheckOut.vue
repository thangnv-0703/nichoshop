<template>
  <div class="contentCheckout">
    ...
    <div class="checkout">
      <div class="content-address">
        ...
        <div class="address">
          <div class="title">
            <svg style="color: #ee4d2d; fill: currentColor" height="16" viewBox="0 0 12 16" width="12"
          ...
          <div class="desc">
            ...
            <span @click="isPopupOpen = true" class="change">Thay Đổi</span>
          </div>
        </div>
      </div>
      <!-- shop 1 -->
        ...
        <div class="detail">
          <div class="shop">
            ...
            <svg style="
                ...
                color: #00bfa5;
                fill: currentColor;
              " viewBox="0 0 16 16" class="shopee-svg-icon FpgzUK">
              <g fill-rule="evenodd">
                <path
          ...
          <div v-for="(item, index) in data.products" :key="index" class="product">
            ...
            <span class="price">₫{{ formatNumberWithDots(item.amount * item.quantity) }}</span>
          </div>
          <div class="vouncher">
            <div class="empty"></div>
          ...
          <div class="note">
            ...
            <div class="right">
              <div class="shipping_method">
                ...
                <div class="time">
                  <span>Nhận Voucher trị giá ₫15.000 nếu đơn hàng được giao đến bạn
          ...
          <div class="total">
            <span class="text">Tổng số tiền ({{ data.products.length }} sản phẩm):</span>
      ...
      <div class="payment">
        <span class="text">Nhấn "Đặt hàng" đồng nghĩa với việc bạn đồng ý tuân theo
  ...
  <ChangeAddressPopup v-model="isPopupOpen" />
</template>
