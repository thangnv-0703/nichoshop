        ...
        <div class="product">
          ...
          <div class="right">
            ...
            <div class="quantity">
              ...
              <div class="desc">
                <button class="decrease" @click.stop="increaseProduct(false)">
                  -
                </button>
                <input type="text" :value="quantityProduct" />
                <button class="increase" @click.stop="increaseProduct(true)">
                  +
                </button>
