        ...
        <div class="detail">
            <div class="content">
                ...
                <div class="product">
                    ...
                    <div class="right">
                        <span class="name">Ghế công thái học Sihoo A3 (Doro C300) chính hãng</span>
                        <div class="vote">
                            <span class="star">
                                <span>4.9</span>
                            ...
                            <div class="feedback">
                                11 <span class="gray">đánh giá</span>
                            </div>
                            <div class="sold">
                                20 <span class="gray">đã bán</span>
                            </div>
                        </div>
                        <div class="price">
                        ...
                        <div class="transport">
                            ...
                            <div class="desc">
                                ...
                                <div class="line-second">
                                    <span class="desc-transport-2">Tặng Voucher ₫15.000 nếu đơn giao sau thời gian
                                        trên.</span>
                                </div>
                            </div>
                        </div>
                        <div class="insurance">
                            ...
                            <div class="desc">
                                ...
                                <span class="text">Trả hàng miễn phí 15 ngày · Bảo hiểm bảo vệ người tiêu dùng</span>
                            </div>
                        </div>
                ...
                <div class="detail">
                    ...
                    <div class="description">
                        <span>🆘🆘 Anh em ở Hà Nội, HCM cần giao ghế hoả tốc thì nhắn tin cho shop hoặc liên hệ số
                            hotline
                            bên dưới. Shop sẽ bật kênh người bán tự vận chuyển và giao ngay cho anh em(nhận hàng sau 20
                            phút-1 giờ). Shop làm việc từ 9h-21h tất cả các ngày trong tuần.</span>
                        <span class="mt-24">✅ A3, A3B(có gác chân) sẵn hàng cả 2 màu: đen và trắng xám giao ngay. Quý
                            khách ở Hanoi vui
                            lòng chọn ship hoả tốc phí ship chỉ vài chục nghìn, nhận hàng ngay sau 30 phút. </span>
                        ...
                        <span>✅ Tựa đầu 3D: điều chỉnh lên xuống, xoay ngữa nghiêng 135 độ, tiến lùi</span>
                        <span>✅ Tính năng khoá vị trí khi ngã đa điểm</span>
                        <span>✅ Piston 4 cấp đạt chứng nhận Ansi/Bifma cho độ bền nâng hạ tới 200.000 lần</span>
                        <span>🌈 Bảo hành chính hãng 5 năm. Sau khi đơn hàng thành công quý khách check thông tin bảo
                            hành bằng cách vào link: baohanh.themanson.vn nhập số điện thoại đã đặt hàng sẽ hiện ra đầy
                            đủ thông tin.</span>
                        <span>——————————————————————————————</span>
        ...
        .product {
            ...
            .right {
                ...
                .shock-deal {
                    ...
                    .desc {
                        background-color: var(--brand-primary-light-color, rgba(255, 87, 34, .1));
                        border-radius: 2px;
                        color: #ee4d2d;
                        font-size: 14px;
                        max-width: 450px;
